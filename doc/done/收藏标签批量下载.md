...
- [x] 绑定相册时必须校验：`downloadPath === gallery.folderPath`
- [x] 支持绑定已有相册，支持自动创建相册
...
- [x] 支持绑定相册时自动创建相册
- [x] 下载完成后自动刷新 / 扫描对应相册
- [x] 支持相册绑定一致性修复提示（路径不一致时显示修复按钮和详情）
- [x] 支持按相册查看"来源 favorite tag"（相册信息弹窗中显示来源标签及下载状态）
...
- [x] 基于相册维度的反向追踪视图（相册信息弹窗中显示来源 favorite tag 及下载状态）
